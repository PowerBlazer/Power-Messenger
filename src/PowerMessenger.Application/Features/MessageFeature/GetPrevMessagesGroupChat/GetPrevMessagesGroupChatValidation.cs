...
public class GetPrevMessagesGroupChatValidation: AbstractValidator<GetPrevMessagesGroupChatQuery>
{
    public GetPrevMessagesGroupChatValidation(IChatService chatService,
