...
[UsedImplicitly]
public class GetPrevMessagesGroupChatValidator: AbstractValidator<GetPrevMessagesGroupChatQuery>
{
    public GetPrevMessagesGroupChatValidator(IChatService chatService,
